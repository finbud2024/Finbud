...
import vietStockImportExport from '../../../models/market-data/vietStockImportExport.js';
...
async function scrapeVietStock() {
    ...
    try {
        ...
        await page.goto("https://finance.vietstock.vn/du-lieu-vi-mo/48-49/xuat-nhap-khau", { 
            timeout: 60000 
        });
...
async function runScrapers() {
    ...
    try {
        ...
        await vietStockImportExport.deleteMany({});

        await vietStockImportExport.insertMany(imExData);
