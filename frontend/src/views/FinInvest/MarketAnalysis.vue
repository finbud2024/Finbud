    ...
    <div class="container-card-big">
      <div class="market-analysis-container">
        ...
        <div class="card-container">
          <div
            v-for="(category, key, index) in marketAnalysis.marketAnalysis
              .components"
            :key="key"
            class="card"
          >
            ...
            <div
              ...
              :style="{
                width: category.Positive + category.Neutral + category.Negative,
              }"
            >
              <span
                class="positive"
            ...
            <div style="display: flex; justify-content: space-between">
              <p>
                {{ t("marketAnalysisPage.LastUpdated") }}:
                {{ category.LastUpdated }}
              </p>
              <a
                :href="`/market-analysis/insight/${category.type}`"
                style="color: white; text-decoration: none"
                >{{ t("marketAnalysisPage.Insight") }}</a
              >
            </div>
          </div>
        </div>
    ...
    <div class="trend-ai-news-container">
      ...
      >
        <div class="topic-container">
          <h2 class="component-title">
            {{ t("marketAnalysisPage.trend.title") }}
          </h2>
                    ...
                    <div style="display: flex; gap: 10px">
                      ...
                      <div :style="{ display: 'flex', gap: '5px' }">
                        ...
                        <div
                          ...
                          :class="{
                            trending: row.Tag === 'Trending',
                            emerging: row.Tag === 'Emerging',
                            falling: row.Tag === 'Falling',
                          }"
                        >
                          {{ row.Tag }}
                        </div>
            ...
            <div class="news-card" style="height: calc(30% - 5px)">
              ...
              <div class="news-content">
                <a
                  ...
                  :href="marketAnalysis.AI_News.AI_News[0].link"
                  target="_blank"
                >
                ...
                <div class="news-tags-container">
                  <div
                    v-for="(tag, index) in marketAnalysis.AI_News.AI_News[0]
                      .tags"
                    :key="index"
                  >
                  ...
                  <td>
                    ...
                    >
                      <div
                        class="progress-bar"
                        :style="{
                          width: (1 - row.mentions / maxVal[title]) * 100 + '%',
                        }"
                      ></div>
                    </div>
                  </td>
...
const getTable = (tName) => {
  tableRows.value =
    marketAnalysis.value.Topic.Articles[selectedDate.value][tName];
};
...
onMounted(async () => {
  getTable(selectedCategory.value);
  smallNewsCardsFirst.value = marketAnalysis.value.AI_News.AI_News.slice(
    1
  ).slice(0, 3);
  smallNewsCardsSecond.value = marketAnalysis.value.AI_News.AI_News.slice(
    1
  ).slice(3, 6);
