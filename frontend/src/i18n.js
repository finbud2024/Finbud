...
const messages = {
  en: {
    ...
    eventHub: {
      ...
      heroTitle: "Find your next financial event",
      heroSubtitle: "Discover events worldwide",
      discoverEvents: "More than {count} financial events worldwide",
      loadingEvents: "Loading events...",
      showMap: "Show Map View",
      showList: "Show List View",
      learnMore: "Learn More",
      mapUnavailable: "Map Service Unavailable",
      browseBelow: "You can still browse events below.",
      noEventsTitle: "Unable to Load Latest Events",
      noEventsDescription: "We're having trouble fetching the latest financial news and events.",
  ...
  vi: {
    ...
    eventHub: {
      ...
      heroTitle: "Tìm sự kiện tài chính tiếp theo của bạn",
      heroSubtitle: "Khám phá sự kiện trên toàn thế giới",
      discoverEvents: "Hơn {count} sự kiện tài chính trên toàn thế giới",
      loadingEvents: "Đang tải sự kiện...",
      showMap: "Hiển thị Bản đồ",
      showList: "Hiển thị Danh sách",
      learnMore: "Tìm hiểu thêm",
      mapUnavailable: "Dịch vụ Bản đồ không khả dụng",
      browseBelow: "Bạn vẫn có thể xem các sự kiện bên dưới.",
      noEventsTitle: "Không thể tải sự kiện mới nhất",
      noEventsDescription: "Chúng tôi gặp sự cố khi tải tin tức và sự kiện tài chính mới nhất.",
      trendingCities: "Thành phố xu hướng",
      events: "sự kiện",
      categories: {
        business: "Kinh doanh",
        conference: "Hội nghị",
