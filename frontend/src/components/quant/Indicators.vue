<template>
  ...
  export default {
    ...
    methods: {
      ...
      SMA(data, period = 100, column = 'Adj Close.svg') {
      ...
      EMA(data, period = 20, column = 'Adj Close.svg') {
        const k = 2 / (period + 1);
      ...
      MACD(data, period_long = 26, period_short = 12, period_signal = 9, column = 'Adj Close.svg') {
      ...
      RSI(data, period = 14, column = 'Adj Close.svg') {
      ...
      BB(data, period = 20, column = 'Adj Close.svg') {
